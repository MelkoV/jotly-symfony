...
final readonly class CreateListItemRequest
{
    /**
    ...
    public function toDto(): CreateListItemData
    {
        return new CreateListItemData(
            trim($this->list_id),
            trim($this->name),
            $this->is_completed ?? (bool) ($this->attributes['is_completed'] ?? false),
